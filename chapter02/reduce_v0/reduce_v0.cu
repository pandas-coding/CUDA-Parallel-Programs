...
// RTX 3060
// C:\bin\reduce0.exe
// sum of 16777216 random numbers: host 8388314.4 273.720 ms, GPU 8388314.0 0.868 ms

#include <random>
#include "cx.h"
#include "cxtimers.h"

__global__ void reduce_v0(float *x, int m) {
...
int main(int argc, char *argv[]) {
    ...
    for (int m = N / 2; m > 0; m /= 2) {
        ...
        reduce_v0<<<blocks, threads>>>(dev_x.data().get(), m);
    }
